...
\begin{DoxyCompactList}\small\item\em creates a body in the physics world, so they affect the game object that this component is attached to. Rigid bodies are perfectly solid, kinematic objects that simulate movement based on forces (Classical/\+Newtonian mechanics) \end{DoxyCompactList}\end{DoxyCompactItemize}
